...
})({"ho3LK":[function(require,module,exports) {
...
//     );
// }
window.onload = ()=>(0, _react.render)(/*#__PURE__*/ (0, _reactDefault.default).createElement((0, _app.App), {
...
},{"./react":"kp9W0","./App":"29gdY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kp9W0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const App = ({ path })=>{
    ...
    else if (path === "/breed") return /*#__PURE__*/ (0, _reactDefault.default).createElement((0, _breed.Breed), {
        path: path,
        __source: {
            fileName: "App.tsx",
            lineNumber: 10,
...
},{"./react":"kp9W0","./Breeds":"5WqmZ","./Breed":"cjApR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5WqmZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Breeds", ()=>Breeds);
var _react = require("./react");
var _reactDefault = parcelHelpers.interopDefault(_react);
const Breeds = ()=>{
    const [breeds, setBreeds] = (0, _react.useState)([], "breeds");
    const [fetchComplete, setFetchComplete] = (0, _react.useState)(false, "fetch");
    // Check if fetchComplete is false before performing the fetch
    if (!fetchComplete) fetch("https://dog.ceo/api/breeds/list/all").then((response)=>response.json()).then((data)=>{
    ...
    return /*#__PURE__*/ (0, _reactDefault.default).createElement("div", {
        ...
        __self: undefined
    }, "Good Bois \uD83D\uDC36"), /*#__PURE__*/ (0, _reactDefault.default).createElement("ul", {
        __source: {
            fileName: "Breeds.tsx",
            lineNumber: 21,
            columnNumber: 7
        ...
        __self: undefined
    }, breeds.map((breed)=>/*#__PURE__*/ (0, _reactDefault.default).createElement("li", {
            key: breed,
            __source: {
                fileName: "Breeds.tsx",
                lineNumber: 23,
...
},{"./react":"kp9W0","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cjApR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Breed = ({ path })=>{
    ...
    if (!loading) {
        ...
        __self: undefined
    }, breed), /*#__PURE__*/ (0, _reactDefault.default).createElement("img", {
        width: "400",
        src: image,
        alt: breed,
        __source: {
...
},{"./react":"kp9W0","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ho3LK","kjLP2"], "kjLP2", "parcelRequire3e22")
